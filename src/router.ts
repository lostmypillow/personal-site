...
const routes = [
  { path: "/", component: Home, name: "林家民",  meta: { title: '林家民' } },
  { path: "/projects", component: Projects, name: "我的專案",   meta: { title: '專案' } },
  { path: "/resumes", component: Resumes, name: "我的履歷" ,   meta: { title: '履歷' }},
];
